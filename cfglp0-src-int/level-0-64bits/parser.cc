// Generated by Bisonc++ V2.09.03 on Sun, 26 Jan 2014 16:47:30 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {296, 6}, // 14: basic_block ('<') ->  '<' NAME INTEGER_NUMBER '>' ':' statement_list
     {297, 2}, // 15: statement (';') ->  executable_statement ';'
     {297, 1}, // 16: statement ->  if_statement
     {297, 2}, // 17: statement (';') ->  goto_statement ';'
     {298, 1}, // 18: if_statement ->  if_block
     {298, 2}, // 19: if_statement ->  if_block else_block
     {299, 5}, // 20: if_block (IF) ->  IF '(' executable_statement ')' goto_statement
     {300, 2}, // 21: else_block (ELSE) ->  ELSE goto_statement
     {301, 6}, // 22: goto_statement (GOTO) ->  GOTO '<' NAME INTEGER_NUMBER '>' ';'
     {302, 2}, // 23: statement_list ->  statement statement_list
     {302, 3}, // 24: statement_list (RETURN) ->  statement RETURN ';'
     {303, 0}, // 25: executable_statement ->  <empty>
     {303, 1}, // 26: executable_statement ->  assignment_statement
     {303, 1}, // 27: executable_statement ->  comparison_statement
     {303, 1}, // 28: executable_statement ->  ternary_statement
     {303, 1}, // 29: executable_statement ->  binary_boolean_statement
     {303, 2}, // 30: executable_statement ('!') ->  '!' executable_statement
     {303, 3}, // 31: executable_statement ('(') ->  '(' executable_statement ')'
     {303, 1}, // 32: executable_statement ->  variable
     {303, 1}, // 33: executable_statement ->  constant
     {304, 2}, // 34: comparison_op ('!') ->  '!' '='
     {304, 2}, // 35: comparison_op ('>') ->  '>' '='
     {304, 2}, // 36: comparison_op ('=') ->  '=' '='
     {304, 2}, // 37: comparison_op ('<') ->  '<' '='
     {304, 1}, // 38: comparison_op ('<') ->  '<'
     {304, 1}, // 39: comparison_op ('>') ->  '>'
     {305, 3}, // 40: comparison_statement ->  executable_statement comparison_op executable_statement
     {306, 5}, // 41: ternary_statement ('?') ->  executable_statement '?' executable_statement ':' executable_statement
     {307, 3}, // 42: binary_boolean_statement (BINARY_LOGICAL_OPERATOR) ->  executable_statement BINARY_LOGICAL_OPERATOR executable_statement
     {308, 2}, // 43: assignment_statement_list ->  assignment_statement_list assignment_statement
     {309, 3}, // 44: assignment_statement ('=') ->  variable '=' executable_statement
     {310, 1}, // 45: variable (NAME) ->  NAME
     {311, 1}, // 46: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {312, 1}, // 47: program_$ ->  program
};
...
{
    { { REQ_DEF}, {  18} },                            
    { {     302}, {  31} }, // statement_list          
    { {     297}, {  32} }, // statement               
    { {     303}, {  33} }, // executable_statement    
    { {     298}, {  34} }, // if_statement            
    { {     301}, {  35} }, // goto_statement          
    { {     309}, {  36} }, // assignment_statement    
    { {     305}, {  37} }, // comparison_statement    
    { {     306}, {  38} }, // ternary_statement       
    { {     307}, {  39} }, // binary_boolean_statement
    { {      40}, {  41} }, // '('                     
    { {     310}, {  42} }, // variable                
    { {     311}, {  43} }, // constant                
    { {     299}, {  44} }, // if_block                
...
SR__ s_33[] =
{
    { { REQ_TOKEN}, {  9} },                           
    { {        59}, { 51} }, // ';'                    
    { {       304}, { 52} }, // comparison_op          
    { {        63}, { 53} }, // '?'                    
    { {       268}, { 54} }, // BINARY_LOGICAL_OPERATOR
    { {        33}, { 55} }, // '!'                    
    { {        62}, { 56} }, // '>'                    
    { {        61}, { 57} }, // '='                    
    { {        60}, { 58} }, // '<'                    
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        { 
         #if 0
         d_val__.ast_list = d_vsp__[-1].ast;
         #endif
         }
        break;
        ...
        { 
         ...
         if (d_vsp__[-2].ast != NULL)
         d_val__.ast_list = d_vsp__[-2].ast;
         else
        ...
        { 
         #if 0
         d_val__.ast = new Assignment_Ast(d_vsp__[-2].ast, d_vsp__[0].ast);
         int line = get_line_number();
